...
from quantfoundry.domain.value_objects.public_ids import PUBLIC_ID_PREFIXES

MANIFEST_PATH = Path(__file__).resolve().parents[4] / "schema/section14_manifest.json"
