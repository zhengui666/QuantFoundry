...
'
  ...
  for variable_name in \
    ...
    GITHUB_SERVER_URL GITHUB_SHA GIT_DIR QF_ALEMBIC_URL QF_BUILD_ID QF_CI_DISPOSABLE_DATABASE \
    QF_CI_REPO_ROOT \
    COREPACK_HOME QF_CODEX_BASE_URL QF_CODEX_DISPLAY_NAME QF_CODEX_MODELS QF_CONTROL_DB_URL \
